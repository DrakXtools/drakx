...
sub print_form {
    print
      p(),
      start_form(-name => 'form', -action => $cgi_name, -method => 'get'),
      ul("Please choose the partition where Moondrake GNU/Linux is copied.",
	 ...
	 li(popup_menu(-name => "partition_number", -default => '0', 
      ...
      p(),
      ul("Please enter the directory containing the Moondrake GNU/Linux Distribution (relative to the partition chosen above)",
