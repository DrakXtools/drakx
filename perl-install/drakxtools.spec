...
perl -ni -e '/activefw\.pm|clock|drak(backup|bug|clock|floppy|font|hosts|log|net_monitor|nfs|perm|printer|sec|splash|TermServ)|gtk|icons|logdrake|net_applet|net_monitor|pixmaps|printer|roam|xf86misc|\.png$/ ? print STDERR $_ : print' %{name}.list 2> %{name}-gtk.list
