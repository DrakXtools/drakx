...
@text = ([ N("<b>Note</b>"), center => 1 ],
	...
	' ',
	N("The free download version does not include commercial software, and therefore may not work with certain proprietary network cards and video cards such as NVIDIA® nForce. To avoid possible compatibiity issues with these devices, we recommend the purchase of one of our retail products that includes commercial drivers and additional software.")); 
