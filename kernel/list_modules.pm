  ...
  multimedia => 
  {
    sound => [
      ...
      if_(arch() !~ /^sparc/,
          ...
          qw(snd-es1938 snd-es1968 snd-es968 snd-fm801 snd-gina20 snd-gina24 snd-gusclassic snd-gusextreme),
          qw(snd-gusmax snd-hdsp snd-ice1712 snd-ice1724 snd-intel8x0 snd-interwave),
          qw(snd-interwave-stb snd-korg1212 snd-layla20 snd-layla24 snd-maestro3 snd-mia snd-mixart snd-mona snd-mpu401 snd-nm256),
