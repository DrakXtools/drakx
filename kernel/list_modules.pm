...
our %l = (
  ...
  multimedia => 
  {
	...
	qw(gus i810_audio ice1712 kahlua mad16 maestro maestro3 mpu401 msnd_pinnacle nvaudio opl3 opl3sa opl3sa2 nm256_audio),
        ...
        qw(snd-ali5451 snd-als100 snd-als4000 snd-atiixp snd-azt2320 snd-azt3328 snd-bt87x snd-cmi8330 snd-cmipci),
	   qw(snd-cs4231 snd-cs4232 snd-cs4236 snd-cs46xx snd-dt019x snd-cs4281 snd-emu10k1),
	   qw(snd-ad1816a snd-ad1848 snd-gusclassic snd-gusextreme snd-gusmax snd-interwave snd-interwave-stb),
	   ...
	   qw(snd-ens1370 snd-ens1371 snd-es18xx snd-es968 snd-es1938 snd-es1968 snd-es1688),
        qw(snd-fm801 snd-hdsp snd-ice1712 snd-ice1724 snd-intel8x0 snd-korg1212 snd-maestro3 snd-mixart),
	   qw(snd-nm256 snd-rme96 snd-rme32 snd-opl3sa2 snd-opti92x-ad1848 snd-opti92x-cs4231 snd-sb16 snd-sgalaxy snd-sonicvibes snd-sscape snd-vxp440 snd-vxpocket),
