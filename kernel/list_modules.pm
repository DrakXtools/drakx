  ...
  network => 
  {
   ...
   #- known drivers :-(
    ...
    wireless => [
      ...
      qw(hostap_cs hostap_pci hostap_plx ipw2100 ipw2200 iwl3945 iwl4965 madwifi_pci netwave_cs orinoco orinoco_cs orinoco_nortel orinoco_pci orinoco_plx orinoco_tmd),
