...
our %l = (
  ...
  network => 
  {
    ...
    gigabit => [
      qw(dl2k e1000 ixgb myri_sbus ns83820 r8169 s2io sk98lin skge tg3 via-velocity yellowfin ),
   ...
   #- known drivers :-(
    ...
    wireless => [
      ...
      qw(prism2_pci prism2_usb prism54 ray_cs rt2400 rt2500 usbvnet_rfmd vt_ar5k wavelan_cs wvlan_cs zd1201),
  ...
  multimedia => 
  {
    sound => [
      ...
      if_(arch() !~ /^sparc/,
          ...
          qw(snd-cs46xx snd-darla20 snd-darla24 snd-dt019x snd-emu10k1 snd-ens1370 snd-ens1371 snd-es1688 snd-es18xx),
          qw(snd-es1938 snd-es1968 snd-es968 snd-fm801 snd-gina20 snd-gina24 snd-gina3g snd-gusclassic snd-gusextreme),
          qw(snd-gusmax snd-hda-intel snd-hdsp snd-ice1712 snd-ice1724 snd-indi snd-indigodj snd-indigoio snd-intel8x0 snd-interwave),
  ...
  # just here for classification, unused categories (nor auto-detect, nor load_thiskind)
  {
    ...
    mouse => [
      qw(busmouse msbusmouse logibusmouse pcips2 qpmouse generic_serial synclinkmp atixlmouse),
